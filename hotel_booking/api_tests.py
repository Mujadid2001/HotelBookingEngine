#!/usr/bin/env python3
"""
Hotel Booking Engine API Test Script
====================================

This script demonstrates all the working API endpoints for the accounts app.
Run this script to test the backend API functionality.
